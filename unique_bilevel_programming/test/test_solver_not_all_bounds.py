...
def test_simple_instance_b_2_without_u():
    solver = UBSolver(eps=10e-2, big_m=10e2)
...
def test_simple_instance_c_without_l():
    solver = UBSolver(eps=1e-2, big_m=1e2)
    solver.solve(inst_2, weights_1_0)
    answer = solver.get_values_by_names(weights_1_0.keys())
...
def test_simple_instance_u_without_l():
    solver = UBSolver(eps=10e-2, big_m=10e2)
    solver.solve(inst_2, weights_1_1)
...
def test_simple_instance_b_without_l():
    solver = UBSolver(eps=10e-2, big_m=10e2)
    solver.solve(inst_2, weights_1_3)
...
def test_simple_instance_b_2_without_l():
    solver = UBSolver(eps=10e-2, big_m=10e2)
    solver.solve(inst_2, weights_1_4)
