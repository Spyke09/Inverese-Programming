...
class MIBPLInstance:
    ...
    def __post_init__(self):
        ...
        self.n_u = max(self.__shape(self.a_r, 0), self.__shape(self.a_z, 0), self.__shape(self.b_r, 0), self.__shape(self.b_z, 0), self.__shape(self.r, 0))
        self.n_l = max(self.__shape(self.p_r, 0), self.__shape(self.p_z, 0), self.__shape(self.q_r, 0), self.__shape(self.q_z, 0), self.__shape(self.s, 0))
